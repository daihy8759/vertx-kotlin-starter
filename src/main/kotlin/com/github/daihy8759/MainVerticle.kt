...
class MainVerticle : CoroutineVerticle() {
    ...
    override suspend fun start() {
        ...
        vertx.deployVerticle(ApiVerticle(), DeploymentOptions().setConfig(config)).await()
        vertx.deployVerticle(TokenVerticle(pool), DeploymentOptions().setConfig(config)).await()
    }
}